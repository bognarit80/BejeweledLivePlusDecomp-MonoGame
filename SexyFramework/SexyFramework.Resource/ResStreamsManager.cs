...
namespace SexyFramework.Resource
{
	public class ResStreamsManager
	{
		...
		public GroupStatus GetGroupStatus(string theGroupName)
		{
			throw new NotImplementedException();
		}

		public GroupStatus GetGroupStatus(int theGroupId)
		{
			throw new NotImplementedException();
		}

		public string GetGroupName(uint theGroupId)
		{
			throw new NotImplementedException();
		}
		...
		public void DebugDraw(SexyFramework.Graphics.Graphics g, Rect aRegion)
		{
			throw new NotImplementedException();
		}
