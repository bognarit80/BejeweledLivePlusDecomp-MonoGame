...
namespace SexyFramework.Graphics
{
	public abstract class RenderDevice
	{
		...
		{
			DrawLine(theStartX, theStartY, theEndX, theEndY, theColor, theDrawMode, false);
		}
		...
		public abstract void BltMatrix(Image theImage, float x, float y, SexyTransform2D theMatrix, Rect theClipRect, Color theColor, int theDrawMode, Rect theSrcRect, bool blend);
		...
		{
			BltTriangles(theImage, theVertices, theNumTriangles, theColor, theDrawMode, tx, ty, true, Rect.INVALIDATE_RECT);
		}
		...
		{
			BltTriangles(theImage, theVertices, theNumTriangles, theColor, theDrawMode, tx, 0f, true, Rect.INVALIDATE_RECT);
		}

		public void BltTriangles(Image theImage, SexyVertex2D[,] theVertices, int theNumTriangles, Color theColor, int theDrawMode)
		{
			BltTriangles(theImage, theVertices, theNumTriangles, theColor, theDrawMode, 0f, 0f, true, Rect.INVALIDATE_RECT);
		}
		...
		{
			BltStretched(theImage, theDestRect, theSrcRect, theClipRect, theColor, theDrawMode, fastStretch, false);
		}
