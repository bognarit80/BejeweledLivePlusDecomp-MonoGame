...
namespace SexyFramework
{
	public class MusicInterface
	{
		...
		public EMusicInterfaceState mCurState = EMusicInterfaceState.State_None;

		public EGameEvent mGameEvent = EGameEvent.State_No;

		public EServiceEvent mServiceEvent = EServiceEvent.State_ServiceNo;
